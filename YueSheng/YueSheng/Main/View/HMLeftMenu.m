...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [self setupBtnWithIcon:@"left01" title:@"新闻快讯" bgColor:YWColorRGBA(202, 68, 73, alpha)];
         [self setupBtnWithIcon:@"left04" title:@"股市行情" bgColor:YWColorRGBA(190, 111, 69, alpha)];
        [self setupBtnWithIcon:@"left03" title:@"节目重温" bgColor: YWColorRGBA(76, 132, 190, alpha)];
        [self setupBtnWithIcon:@"left02" title:@"股市广播" bgColor:YWColorRGBA(120, 255, 150, alpha)];
        [self setupBtnWithIcon:@"left06" title:@"闪电行情" bgColor:YWColorRGBA(170, 172, 73, alpha)];
        [self setupBtnWithIcon:@"left07" title:@"投资快报" bgColor:YWColorRGBA(190, 62, 119, alpha)];
